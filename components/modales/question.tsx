...
export const ModalQuestion = ({ message, onClose, onConfirm }: ModalQuestion) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg max-w-sm w-full mx-4 lg:mx-0 ">
                ...
                <div className="flex justify-center space-x-4 mt-4">
                    <button onClick={onConfirm} className="px-4 py-2 border rounded-lg bg-cyan-500 text-white">
                        Aceptar
                    </button>
                    <button onClick={onClose} className="px-4 py-2 border rounded-lg bg-gray-500 text-white">
                        Cancelar
                    </button>
                </div>
            </div>
