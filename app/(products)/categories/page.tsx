        ...
        <div className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="flex flex-row mt-6 justify-between mr-10">
                <div className="text-zinc-600 flex lg:text-base text-xs items-center">
                    <span>Mostrando {filteredCategories.length === 0 ? 0 : indexOfFirstUser + 1} - {Math.min(indexOfLastCategorie, filteredCategories.length)} de {categories.length} producto(s)</span>
                </div>
